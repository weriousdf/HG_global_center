...
function screenHome() {
  ...
  <section class="sect">
    <div class="cta-band">
      ...
      ${/* 이 문구는 카카오 주소가 설정되지 않아도 항상 보여야 한다. 전화도 안내하고 있고,
            사용자가 중요한 글로 지정했다. 처음에 카카오 버튼과 함께 조건에 묶어 두어
            주소가 비었을 때 문구까지 사라졌다.
            세 줄로 끊어 쓴 문구라 좁은 칸에 넣으면 또 접히므로 밴드 전체 폭을 쓴다. */ ''}
      <p class="kakao-invite">서류 준비가 처음이라 잘 모르시더라도 괜찮습니다.<br class="wide-only">
